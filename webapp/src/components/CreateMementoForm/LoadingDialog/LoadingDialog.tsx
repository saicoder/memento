  ...
  return (
    <>
      ...
      <div className="dialog">
        <Image alt="logo-small" src="logo-small.svg" width={100} height={100} />
        <div className="flex gap-2 font-light border border-fg rounded-[12px] px-[14px] py-[10px] max-w-[560px] mb-4">
          ...
          <div className="ml-[8px]">
            Just a moment, this may take a little while. Please don&apos;t close or refresh the
            page, it&apos;ll stop your note from being sent.
          </div>
        </div>
        ...
        {currentStep >= steps.length - 1 && (
          <div className="border-t border-fg w-full px-[36px]">
            <p className="mt-[21px] mb-[4px]">Link to Memento</p>
            <div className="bg-bg-alt rounded-[12px] h-[40px] relative">
              <p className="max-w-[330px] text-black mb-2 leading-[40px] px-4 truncate">{link}</p>
              <CopyButton copyContent={link ?? ''} />
            </div>

            <p className="mt-[21px] mb-[4px]">Password for the recipient</p>
